              ...
              <div class="row">
                <div class="col-md-4">
                  <aside class="widget widget_text">
                    <a href="Home_01.html">
					 <img src="images\Home\Home4\airlogotemp45.png" alt="footer logo">
					</a>
                    <p>In 2014, We launched Travellers with the belief that other travellers would share our desire to experience authentic adventures in a responsible and sustainable manner. <br> <br> We've grown from a one-man show to a company of over 50 world wide, and from a handful of trips in all over the world. </p>
                ...
                <div class="col-md-4">
                  <aside class="widget widget_recent_entries">
                    ...
                    <ul>
                      <li>
                        <img src="images\Flight224.jpg" alt="Recent blog" />
                        <div>
                          <p>Bristish Airways Boeinf 747-400..</p>
                          <a href="">Read More</a> 
                        </div>
                      </li>
                      <li>
                        <img src="images\Flight556.jpg" alt="Recent blog" />
                        <div>
                          <p>Boeing 747 of China Airlines..</p>
                          <a href="">Read More</a> 
                        </div>
                      </li>
                    </ul>
          ...
          <div class="copyright">
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 text-right"> <span>Alliance Flight@2020. All Right Reserved</span> </div>
              </div>
            </div>
          </div>
        </div>
